// ---------------------------------------------------------------------------
//   Dubh Java Utilities
//   $Id: ContentsParser.java,v 1.4 1999-11-11 21:24:34 briand Exp $
...
class ContentsParser {
   ...
   * Retrieves the tree model for this HTML Contents file.
   @throws org.javalobby.dju.html.HTMLParseException if the HTML in the contents file is dodgy.
   */
