...
/**
 * A tool argument that represents the classpath of the current project
 * context
 *
 * @author Brian.Duff@oracle.com
 */
public final class ProjectClasspath implements ToolArgument
{
  ...
  {
    return
      ToolManagerArb.getString( ToolManagerArb.PROJECT_CLASSPATH_NAME );
  }

  public String getDescription()
  {
    return
      ToolManagerArb.getString( ToolManagerArb.PROJECT_CLASSPATH_DESCRIPTION );
  }
  ...
  public String getValue( Context context )
  {
    ...
    return ((JProject)context.getProject()).getClassPath().toString();
  }

  public String getMoniker()
  {
    return "classpath";   // NOTRANS
  }
