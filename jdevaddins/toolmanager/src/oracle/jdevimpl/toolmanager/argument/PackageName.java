...
/**
 * A tool argument that represents the package name of the selection
 *
 * @author Brian.Duff@oracle.com
 */
public final class PackageName implements ToolArgument
{
  ...
  {
    return
      ToolManagerArb.getString( ToolManagerArb.PACKAGE_NAME_NAME );
  }

  public String getDescription()
  {
    return
      ToolManagerArb.getString( ToolManagerArb.PACKAGE_NAME_DESCRIPTION );
  }
  ...
  public String getValue( Context context )
  {
    ...
    return ((PackagedSource)context.getElement()).getPackage(
      (JProject)context.getProject() );
  }

  public String getMoniker()
  {
    return "packageName";   // NOTRANS
  }
