...
/**
 * A tool argument that represents the path of the selection
 *
 * @author Brian.Duff@oracle.com
 */
public final class Path implements ToolArgument
{
  ...
  {
    return
      ToolManagerArb.getString( ToolManagerArb.PATH_NAME );
  }

  public String getDescription()
  {
    return
      ToolManagerArb.getString( ToolManagerArb.PATH_DESCRIPTION );
  }
