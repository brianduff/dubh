...
public class EnumParser {
	...
	static void output(String name, int val) throws IOException
	{
	...
	static void parse( File file) throws IOException
	{
		...
		else
		{
			...
			while ( true )
			{
				...
				else if ( str.startsWith("enum") && (str.indexOf('(') <0) )
				{
					int enumVal = 0;
					...
					int i =0;
					while ( Character.isUnicodeIdentifierPart(str.charAt(i)) ||
