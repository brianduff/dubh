 ...
 * Tile info handler.
 */
public class PHTileInfo extends AbstractHandler
   implements Constants
{
   ...
   public void handleOnEventThread(Client c, Packet pkt)
   {
      ...
      c.getTileSpec().setTerrain(pmi,
         true           // Need to sort out the state stuff(c.getGameState()==CLIENT_GAME_RUNNING_STATE)
      );
   }
