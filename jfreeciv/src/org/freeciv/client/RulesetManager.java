...
public class RulesetManager implements Constants
{
  ...
  public static RulesetType TYPE_CONTROL = new RulesetType(), TYPE_TECH = new RulesetType(), TYPE_GOVERNMENT = new RulesetType(), TYPE_UNIT = new RulesetType(), TYPE_BUILDING = new RulesetType(), TYPE_TERRAIN_CTRL = new RulesetType(), TYPE_TERRAIN = new RulesetType(), TYPE_CITY = new RulesetType(), TYPE_NATION = new RulesetType();
  ...
  public void addRulesetListener( RulesetType type, RulesetListener rl )
  {
    if( m_hmTypedListeners == null )
    {
      m_hmTypedListeners = new HashMap();
    }
