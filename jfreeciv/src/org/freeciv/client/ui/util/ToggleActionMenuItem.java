   ...
   implements PropertyChangeListener
{
   ...
   public ToggleActionMenuItem(AbstractToggleAction aca)
   {
      ...
      KeyStroke key = (KeyStroke)
         aca.getValue(AbstractToggleAction.ACCELERATOR);
      if (key != null)
      {
         setAccelerator(key);
      }
      String mn = (String)
         aca.getValue(AbstractToggleAction.MNEMONIC);
   ...
   public void propertyChange(PropertyChangeEvent pe)
   {
      ...
      else if (AbstractToggleAction.VISIBLE.equals(pe.getPropertyName()))
      {
      ...
      else if (AbstractToggleAction.TOGGLE_STATE.equals(pe.getPropertyName()))
      {
