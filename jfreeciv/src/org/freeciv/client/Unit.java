...
public class Unit extends PktUnitInfo implements FlashingIcon
{
  ...
  public void reallyPaintIcon( Component c, Graphics g, int x, int y, boolean topOfStack )
  {
  ...
  {
    if( t.getId() == Constants.T_OCEAN && prototype.move_type == Constants.LAND_MOVING )
    {
      return false;
    }
    return true;
  ...
  {
    return ( movesleft > 0 && activity == Constants.ACTIVITY_IDLE && !ai );
  }
