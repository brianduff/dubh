...
public final class Logger
{
        ...
        if (logLevel == m_prev_level && m_lastMessage.equals(message))
         {
            ...
            {
               String buf = "last message repeated "+(m_repeated-m_prev)+
                  " times";
         ...
         else
         {
            if (m_repeated > 0 && m_repeated != m_prev)
            {
               ...
               else
               {
                  ...
                  {
                     buf = "last message repeated "+(m_repeated-m_prev)+
                        " times";
                  }
                  if (m_repeated > 2)
                  {
   ...
   //
   private static class StderrLogHandler extends BaseLogHandler
   ...
   //
   private static class FileLogHandler extends BaseLogHandler
      implements LogHandler
   {
      PrintWriter bw;
