...
/**
 * A JavaMail storage class for the network news protocol.
 *
...
public class NNTPStore extends Store {//implements StatusSource {
	 ...
	 */
	public void sendMessage(Message article, Address[] addresses) throws MessagingException {
		Vector v = new Vector();
	...
	void readNewsrc() {
		try {
			File newsrc = new File(System.getProperty("user.home")+File.separator+".newsrc");
