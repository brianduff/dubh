...
//   $Id: Subscriptions.java,v 1.1 2000-06-14 21:38:59 briand Exp $
...
import org.javalobby.apps.newsagent.navigator.services.news.ui.NewsGroupSubscriptions;
...
/**
 *
 * This command edits the subscriptions of a news server
 *
 * @author Brian Duff (dubh@btinternet.com)
 * @version $Id: Subscriptions.java,v 1.1 2000-06-14 21:38:59 briand Exp $
 */
public class Subscriptions extends AbstractCommand
{
   private static final String NAME = "news.provider.subscriptions";
   ...
   public void doCommand(Object target)
   {
      ...
      NewsGroupSubscriptions sub = new NewsGroupSubscriptions();
      try
      {
         sub.showDialog(GlobalState.getMainFrame(), server);
      }
