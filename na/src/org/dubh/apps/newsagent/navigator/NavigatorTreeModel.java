// ---------------------------------------------------------------------------
//   NewsAgent
//   $Id: NavigatorTreeModel.java,v 1.6 2001-02-11 02:51:01 briand Exp $
 ...
 * serviceCommands.1 = org.dubh.apps.newsagent.navigator.services.nntp.command.service.AddServer
 *
 * providerCommands.count = 1
 * providerCommands.1 = org.dubh.apps.newsagent.navigator.services.nntp.command.provider.Subscriptions
 *
 * folderCommands.count = 1
 * folderCommands.1 = org.dubh.apps.newsagent.navigator.services.nntp.command.folder.Unsubscribe
 *
 * providers.count = 1
 ...
 * @version $Id: NavigatorTreeModel.java,v 1.6 2001-02-11 02:51:01 briand Exp $
 */
...
// Revision 1.5  2000/06/14 21:36:46  briand
