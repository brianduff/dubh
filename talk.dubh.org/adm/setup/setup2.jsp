...
<ul>
	<font size="2">
	Jive needs to connect to a database in order to function properly. Fill in
	the following fields with the connection information for your database. Note: you should already
	have completed the import of the Jive database schema as outlined in the installation guide.
	<p>
