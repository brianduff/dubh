#!/bin/sh
#
# $Id: dubhsnapshots.cgi,v 1.5 1999-06-09 00:07:13 briand Exp $
...
NASIZE=`ls -l $NAJAR.zip | cut -b31-41`
KNASIZE=$[$NASIZE/1024]
...
DJUSIZE=`ls -l $DUJAR.zip | cut -b31-41`
...
DMPSIZE=`ls -l $DMPJAR.zip | cut -b31-41`
...
# Revision 1.4  1999/06/08 23:54:23  briand
# Oh yeah, there are three components. D'oh!
#
